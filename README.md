...
![MedDocAI answering a patient question, showing each agent as it runs and the corrective-RAG loop self-correcting](https://raw.githubusercontent.com/Qingyun-Wang/MedDocAI/main/docs/demo.gif)
